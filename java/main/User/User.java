	...
	private void createUser() throws Exception {
		...
		try {
			...
			if (first) {
				...
				if (!trustedPublicKeys.containsKey(keyString)
						|| !trustedPublicKeys.get(keyString).equals(hashedKeyString)) {
			...
			if (res.contains("successfully logged in")) {
				...
				while (loop) {
					System.out.println(
							"Type (1) to Logoff, (2) to add new friend, (3) to respond to friend request, (4) to remove a friend, (5) to flip your status, (6) to block another user, (7) to delete account");
